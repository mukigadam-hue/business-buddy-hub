      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden md:flex w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
          ...
          <div className="px-3 pt-3">
            <Select value={currentBusiness?.id || ''} onValueChange={v => { setCurrentBusinessId(v); navigate('/'); }}>
            ...
            <div className="mt-3 mb-2">
              ...
              <div className="max-h-40 overflow-y-auto space-y-1.5 rounded-lg border border-border p-1.5">
                {businesses.map(b => {
                  ...
                  return (
                    <button key={b.id} onClick={() => { setCurrentBusinessId(b.id); navigate('/'); setSheetOpen(false); }}
