...
export default function FactoryServices() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const newService = await addService(
      { service_name: toSentenceCase(form.service_name.trim()), description: form.description.trim(), cost: totalCost, customer_name: toTitleCase(form.customer_name.trim()), seller_name: toTitleCase(form.seller_name.trim()), payment_status: 'paid', amount_paid: totalCost, balance: 0 },
